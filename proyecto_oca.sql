...
INSERT INTO `detallespartida` (`IdPartida`, `IdJugador`, `Casilla`, `Orden`, `Bloqueo`, `CasillaActual`, `TurnosCastigo`, `Color`) VALUES
	...
	(13, 2, 1, 2, 0, 22, 0, NULL),
	(14, 1, 1, 2, 0, 10, 0, NULL),
	(14, 3, 1, 1, 0, 7, 0, NULL),
	(15, 1, 1, 1, 0, 10, 0, NULL),
	(15, 2, 1, 4, 0, 15, 0, NULL),
	(15, 4, 1, 2, 0, 26, 0, NULL),
	(15, 5, 1, 3, 0, 22, 0, NULL),
	(40, 5, 1, 2, 0, 1, 0, NULL),
	(40, 9, 1, 1, 0, 1, 0, NULL),
	(41, 5, 1, 1, 0, 13, 0, NULL),
	(41, 9, 1, 2, 0, 11, 0, NULL),
	(42, 5, 1, 2, 0, 57, 0, NULL),
	(42, 9, 1, 1, 0, 63, 0, NULL),
	(43, 5, 1, 1, 0, 1, 0, NULL),
	(43, 9, 1, 2, 0, 1, 0, NULL),
	(44, 5, 1, 1, 0, 1, 0, NULL),
	(44, 9, 1, 2, 0, 1, 0, NULL),
	(45, 5, 1, 2, 0, 1, 0, NULL),
	(45, 9, 1, 1, 0, 9, 0, NULL),
	(46, 5, 1, 1, 0, 63, 0, NULL),
	(46, 9, 1, 2, 0, 56, 0, NULL),
	(47, 5, 1, 1, 0, 4, 0, NULL),
	(47, 9, 1, 2, 0, 2, 0, NULL),
	(48, 5, 1, 1, 0, 2, 0, NULL),
	(48, 9, 1, 2, 0, 1, 0, NULL),
	(49, 5, 1, 1, 0, 63, 0, NULL),
	(49, 9, 1, 2, 0, 51, 0, NULL),
	(50, 5, 1, 1, 0, 26, 0, NULL),
	(50, 9, 1, 2, 0, 85, 0, NULL),
	(51, 5, 1, 1, 0, 57, 0, NULL),
	(51, 9, 1, 2, 0, 57, 0, NULL),
	(52, 5, 1, 1, 0, 1, 0, NULL),
	(52, 9, 1, 2, 0, 1, 0, NULL),
	(53, 5, 1, 1, 0, 58, 0, NULL),
	(53, 9, 1, 2, 0, 58, 0, NULL),
	(54, 5, 1, 1, 0, 1, 0, NULL),
	(54, 9, 1, 2, 0, 1, 0, NULL),
	(55, 5, 1, 1, 0, 1, 0, NULL),
	(55, 9, 1, 2, 0, 1, 0, NULL),
	...
	(57, 5, 1, 1, 0, 2, 0, NULL),
	(57, 9, 1, 2, 0, 1, 0, NULL),
	(58, 5, 1, 1, 0, 16, 0, NULL),
	(58, 9, 1, 2, 0, 1, 0, NULL),
	(59, 5, 1, 1, 0, 4, 0, NULL),
	(59, 9, 1, 2, 0, 1, 0, NULL),
	(60, 5, 1, 1, 0, 4, 0, NULL),
	(60, 9, 1, 2, 0, 1, 0, NULL),
	(61, 5, 1, 1, 0, 58, 0, NULL),
	(61, 9, 1, 2, 0, 1, 0, NULL),
	(62, 5, 1, 1, 0, 9, 0, NULL),
	(62, 9, 1, 2, 0, 1, 0, NULL),
	(63, 5, 1, 1, 0, 8, 0, NULL),
	(63, 9, 1, 2, 0, 17, 0, NULL),
	(64, 5, 1, 1, 0, 61, 0, NULL),
	(64, 9, 1, 2, 0, 43, 0, NULL),
	(65, 5, 1, 1, 0, 20, 0, NULL),
	(65, 9, 1, 2, 0, 28, 0, NULL),
	(66, 5, 1, 1, 0, 16, 0, NULL),
	(66, 9, 1, 2, 0, 27, 0, NULL),
	(67, 5, 1, 2, 0, 62, 0, NULL),
	(67, 9, 1, 1, 0, 55, 0, NULL),
	(68, 5, 1, 1, 0, 62, 0, NULL),
	(68, 9, 1, 2, 0, 59, 0, NULL),
	(69, 5, 1, 1, 0, 51, 0, NULL),
	(69, 9, 1, 2, 0, 60, 0, NULL),
	(70, 1, 1, 1, 0, 1, 0, NULL),
	(70, 2, 1, 2, 0, 1, 0, NULL),
	(71, 1, 1, 1, 0, 1, 0, 1),
	(72, 1, 1, 1, 0, 1, 0, 1),
...
INSERT INTO `partidas` (`IdPartida`, `Nombre`, `IdJugadorTurno`, `IdEstado`, `Password`, `UltimoValorDado`, `IdUltimoMensaje`, `IdUltimoJugadorAccion`) VALUES
	...
	(64, 'Sala de pablofa', 9, 2, NULL, 6, 11, 5),
	...
	(70, 'Sala de alejandro', 1, 1, NULL, 0, 1, NULL),
	(71, 'Sala de alejandro', 1, 1, NULL, 0, 1, NULL),
	(72, 'Sala de alejandro', 1, 1, NULL, 0, 1, NULL),
	(73, 'Sala de alejandro', 1, 1, NULL, 0, 1, NULL),
	(74, 'Sala de alejandro', 1, 1, NULL, 0, 1, NULL),
	(75, 'Sala de alejandro', 1, 1, NULL, 0, 1, NULL),
	(76, 'Sala de alejandro', 1, 1, NULL, 0, 1, NULL),
	(77, 'Sala de alejandro', 1, 1, NULL, 0, 1, NULL),
	(78, 'Sala de alejandro', 1, 1, NULL, 0, 1, NULL),
	(79, 'Sala de alejandro', 1, 1, NULL, 0, 1, NULL),
	(80, 'Sala de alejandro', 1, 2, NULL, 0, 1, NULL),
	(81, 'Sala de alejandro', 1, 2, NULL, 0, 1, NULL),
	(82, 'Sala de alejandro', 1, 2, NULL, 0, 1, NULL),
